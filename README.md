...
* **2학년 1학기 전공과목 (진행 중)**
* **제조 데이터 분석과 최적화 - 김한진 교수님**
    * 제조 공정 데이터 기반의 분석 방법론 및 공정 최적화 알고리즘 학습
* **지능화 캡스톤 프로젝트 - 김영진 교수님**
    * 산업 현장의 실무 문제를 AI 기술로 해결하는 프로젝트 기획 및 구현

* **1학년 2학기 전공과목**
* **(공통) 어플렌티스 프로젝트 - 문성태 교수님**
    * 데이터 분석 및 인공지능 알고리즘 이해
    * 실제 데이터 분석 프로젝트 수행 능력 함양 
* **(심화) 패턴인식 - 김영진 교수님**
    * 패턴인식의 기본 개념과 접근방식 이해
    * 지도학습 및 비지도학습의 원리와 적용 사례
    * 이상탐지와 예지보전 등 산업 및 실생활 적용 주제 학습
...
<p align="center">
  🔗 <strong><a href="https://github.com/songgongho">Industrial AI 전문가 송공호</a></strong> | Python/ML 중심 개발자
</p>

<p align="center">
  <img src="https://img.shields.io/badge/⭐%20Featured-10%20Projects-brightgreen?style=for-the-badge&logo=github&logoColor=white"/>
...
**산업 AI 프로젝트 경험** | **스마트팩토리 전문** | **데이터 기반 문제 해결**
